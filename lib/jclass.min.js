...
nsKey="JClass";}}(function(d,f){var b=d[f];var a={extendable:true,ctorName:"init",superName:"_super",enablePrivacy:true,privatePattern:/^__.+/,tracking:true,privateName:"__",methodsKey:"__jcMethods__",depthKey:"__jcDepth__",callerDepthKey:"__jcCallerDepth__"};
...
}var D;if(g.privateName){D=this[g.privateName];this[g.privateName]=D||s;}var y,E,x,J;if(g.privatePattern){if(this[g.callerDepthKey]===undefined){this[g.callerDepthKey]=k;
...
var C=this[g.methodsKey][z][k];this[g.methodsKey][z][k]=function(){var L=this[g.superName];this[g.superName]=this[g.methodsKey][z][k-1];var K=C.apply(this,arguments);
this[g.superName]=L;return K;};}i=this[g.methodsKey];}else{this[g.methodsKey]=i;}E={};for(var z in this[g.methodsKey]){E[z]=this[z];var F=Math.max.apply(Math,Object.keys(i[z]));
