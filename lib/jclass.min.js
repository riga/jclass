...
this._super=h[j];var p=this._private;this._private=this._private||i;var l=this._methods;this._methods=this._methods||c;for(var n in c){this._methods[n]=this._methods[n]||c[n];
}for(var n in this._methods){this[n]=this._methods[n];}var m=k.apply(this,arguments);for(var n in c){delete this[n];}this._methods=l;if(this._methods===undefined){delete this._methods;
