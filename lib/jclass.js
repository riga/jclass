...
JClass.extend = function(prop, extendable) {
        ...
        if (prop[name] instanceof Function) {
            var protoFn = (function(name, fn) {
                return function() {
                    ...
                    // merge the '_methods' of the super classes into the
                    // '_methods' defined in this scope when 'init' is called
                    // (this requires the super's 'init' methods to be called!)
                    if (name == 'init') {
